...
public class StringMain {
    ...
    public static void main(String[] args) {
        ...
        // 해당 문자열이 변하지는 않는다.
        System.out.println(fruits);
        //시작 인덱스에서 끝까지 자른 값을 리턴해준다.
        System.out.println(fruits.substring(13));


        // .replace(바뀔 문자열, 바꾸고 싶은 문자열)
        // 해당 문자
        // 열에서 특정 문자열을 바꾸고 싶은 문자열로 교체한 값을 리턴
        ...
        // .toUpperCase()
        // .toLowerCase()
        // 해당 문자열에 존재하는 알파벳들을 전부 대문자/소문자로 바꿔준다.
...
//.concat(문자열)
        ...
        //System.out.println(nullthing.length());
