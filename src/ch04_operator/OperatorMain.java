...
//        해당 문자열이 괄호 안 문자열과 같다면 true, 다르면 false 리턴
        ...
        int score = 85;
        // score가 90점 이상이면 "A", 90점 미만이면 "B"가 grade에 담기
        ...
        // !를 bollean 타입 앞에 붙여주면 (true/false) 값을 뒤집는다.
        ...
        // 비트연산자 XOR
        // ^
        // 각 자리수를 비교해서 서로 다른 경우에만 그 자리에 1이 남는방식
        ...
        // 십진수 303과 147에 대해서 비트연산자 &를 직접 해보
